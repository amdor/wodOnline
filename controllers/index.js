var skyscraperModule = module("skyscraper");

skyscraperModule.controller( 'ScraperController', ['$scope', function($scope) {
    ...
    $scope.savedUris = JSON.parse(sessionStorage.inputUriTextContent);
